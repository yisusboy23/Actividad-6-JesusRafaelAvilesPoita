...
namespace Actividad6.REPORTE {
    ...
    public partial class Ds : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DataTable1Row AddDataTable1Row(System.DateTime FechaVenta, decimal TotalVenta, string NombreProducto, int CantidadVendida, decimal PrecioVenta) {
...
namespace Actividad6.REPORTE.DsTableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-JDKQ9F6\\SQLEXPRESS;Initial Catalog=TIENDABD;Integrated Securi" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        V.FECHA AS FechaVenta, V.TOTAL AS TotalVenta, P.NOMBRE AS NombreProducto, DV.CANTIDAD AS CantidadVendida, DV.PRECIOVENTA AS PrecioVenta
FROM            VENTA AS V INNER JOIN
                         DETALLEVENTA AS DV ON V.IDVENTA = DV.IDVENTA INNER JOIN
...
WHERE        V.IDCLIENTE =@x ";
        ...
        public virtual int Fill(Ds.DataTable1DataTable dataTable, int x) {
        ...
        public virtual Ds.DataTable1DataTable GetData(int x) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(x));
